		...
		$.getJSON('https://www.googleapis.com/youtube/v3/channels?part=statistics&id='+user2+'&key='+rightKey, function(data2) {
					...
					if (chart.series[0].data.length >= 900) {
						...
						if (rightKeys.length == 0) {
							$.getJSON('https://reeeeeeeeee.munnyreol786.github.io/yt_data?type=channel&part=statistics&id='+user1, function(data) {
								$.getJSON('https://reeeeeeeeee.munnyreol786.github.io/yt_data?type=channel&part=statistics&id='+user2, function(data2) {
									if (data.id == user1) {
					...
					$.getJSON('https://www.googleapis.com/youtube/v3/channels?part=snippet,brandingSettings&id='+user2+'&key=AIzaSyAzRmWRQKbQpnAIH-Ws0ruzgxafjECdBCg', function(data2) {
						...
						if (data.items[0].brandingSettings.image.bannerImageUrl != "http://s.ytimg.com/yts/img/channels/c4/default_banner-vfl7DRgTn.png") {
							if (data2.items[0].brandingSettings.image.bannerImageUrl != "http://s.ytimg.com/yts/img/channels/c4/default_banner-vfl7DRgTn.png") {
								...
								YT.UpdateManager.updateBanners(data.items[0].brandingSettings.image.bannerImageUrl, "https://munnyreol786.github.io/yt-sub-counter/compare/assets/img/banner.jpg")
							}
						} else {
							YT.UpdateManager.updateBanners("https://munnyreol786.github.io/yt-sub-counter/compare/assets/img/banner.jpg", data2.items[0].brandingSettings.image.bannerImageUrl)
						}
						...
						if (data.items[0].brandingSettings.image.bannerImageUrl == "http://s.ytimg.com/yts/img/channels/c4/default_banner-vfl7DRgTn.png" && data2.items[0].brandingSettings.image.bannerImageUrl == "http://s.ytimg.com/yts/img/channels/c4/default_banner-vfl7DRgTn.png") {
							YT.UpdateManager.updateBanners("https://munnyreol786.github.io/yt-sub-counter/compare/assets/img/banner.jpg", "https://munnyreol786.github.io/yt-sub-counter/compare/assets/img/banner.jpg")
						}
			
						YT.UpdateManager.updateNames(data.items[0].snippet.title, data2.items[0].snippet.title)
						ok = true;
					}).fail(function() {
						$.getJSON('https://reeeeeeeeee.munnyreol786.github.io/yt_data?type=channel&part=snippet&id='+user1, function(data) {
							$.getJSON('https://reeeeeeeeee.munnyreol786.github.io/yt_data?type=channel&part=snippet&id='+user2, function(data2) {
...
function search1() {
    ...
    $.getJSON('https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&type=channel&fields=items%2Fsnippet%2FchannelId&q=' + replaceurl + '&key='+rightKey, function(data) {
		...
		$.getJSON('https://reeeeeeeeee.munnyreol786.github.io/yt_data?type=search&part=channel&q='+replaceurl, function(data) {
			window.location.href = "https://munnyreol786.github.io/yt-sub-counter/compare/?c1="+data.snippet.channelId+"&c2="+user2
		})
	})
}
...
function search2() {
    ...
    $.getJSON('https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&type=channel&fields=items%2Fsnippet%2FchannelId&q=' + replaceurl + '&key='+rightKey, function(data) {
		...
		$.getJSON('https://reeeeeeeeee.munnyreol786.github.io/yt_data?type=search&part=channel&q='+replaceurl, function(data) {
			window.location.href = "https://munnyreol786.github.io/yt-sub-counter/compare/?c1="+user1+"&c2="+data.snippet.channelId
		})
	})
}
